...
- (void) addSomeView{
    ...
    timeLabel.backgroundColor = APP_BLUE_COLOR;
...
//    _btView.backgroundColor = [UIColor colorWithRed:(float)0xfe/256.0 green:(float)0x65/256.0 blue:(float)0x53/256.0 alpha:1];
    ...
    _photoCaptureButton = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH/2 - 31.5, SCREEN_HEIGHT- 120, 60, 60)];
//    _photoCaptureButton.backgroundColor = [UIColor colorWithRed:(float)0xfe/256.0 green:(float)0x65/256.0 blue:(float)0x53/256.0 alpha:1];
    [_photoCaptureButton setBackgroundImage:[UIImage imageNamed:@"拍摄"] forState:(UIControlStateNormal)];
...
//    [_photoCaptureButton makeCornerRadius:31.5 borderColor:[UIColor blackColor] borderWidth:1.5];
    ...
    _camerafilterChangeButton.frame = CGRectMake(SCREEN_WIDTH - 160+17,  25, 30.0, 30.0);
    ...
    UIButton* backBtn = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - 43, 25, 30, 30)];
    ...
    _cameraPositionChangeButton = [[UIButton alloc] initWithFrame:CGRectMake(SCREEN_WIDTH - 110+17, 25, 30, 30)];
    ...
    UIImage* img3 = [UIImage imageNamed:@"拍摄完成"];
    ...
    UIImage* img4 = [UIImage imageNamed:@"删除拍摄"];
    ...
    _inputLocalVieoBtn.frame = CGRectMake( 50 , SCREEN_HEIGHT- 130, 60, 100);
    UIImage* img5 = [UIImage imageNamed:@"上传本地相册"];
    [_inputLocalVieoBtn setImage:img5 forState:UIControlStateNormal];
    [_inputLocalVieoBtn setTitle:@"上传" forState:(UIControlStateNormal)];
    _inputLocalVieoBtn.titleLabel.font = [UIFont systemFontOfSize:12];
    ...
    CGFloat offset = 8.0;
    _inputLocalVieoBtn.titleEdgeInsets = UIEdgeInsetsMake(0, -_inputLocalVieoBtn.imageView.frame.size.width, -_inputLocalVieoBtn.imageView.frame.size.height-offset/2, 0);
    ...
    _inputLocalVieoBtn.imageEdgeInsets = UIEdgeInsetsMake(-_inputLocalVieoBtn.titleLabel.intrinsicContentSize.height-offset/2, 0, 0, -_inputLocalVieoBtn.titleLabel.intrinsicContentSize.width);
...
//        _photoCaptureButton.backgroundColor = [UIColor colorWithRed:(float)0xfe/256.0 green:(float)0x65/256.0 blue:(float)0x53/256.0 alpha:1];
        ...
        [_photoCaptureButton setBackgroundImage:[UIImage imageNamed:@"正在拍摄"] forState:(UIControlStateNormal)];
        if (_isRecoding) {
...
-(void)clickInputBtn:(UIButton*)sender {
    ...
    [imagePickerVc setNavLeftBarButtonSettingBlock:^(UIButton *leftButton) {
        ...
        leftButton.frame=CGRectMake(-15, 20, 20, 44);
    }];
        ...
        if (iOS8Later) {
            ...
            [manager requestAVAssetForVideo:myasset options:options resultHandler:^(AVAsset * _Nullable asset, AVAudioMix * _Nullable audioMix, NSDictionary * _Nullable info) {
                dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    if (videoData.length>1024*1024*19.5) {
                        HUD.label.text = @"所选视频大于20M,请重新选择";
...
- (void)mergeAndExportVideos:(NSArray*)videosPathArray withOutPath:(NSString*)outpath{
    ...
    UIImage* waterImg = [UIImage imageNamed:@""];
    ...
    [exporter exportAsynchronouslyWithCompletionHandler:^{
        dispatch_async(dispatch_get_main_queue(), ^{
            ...
            view.width = self->_width;
            view.hight = self->_hight;
            view.bit = self->_bit;
            view.frameRate = self->_frameRate;
            view.viderType = self.viderType;
            view.targetId = self.targetId;
            view.tagModel = self.tagModel;
