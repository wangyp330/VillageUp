...
//    [SVProgressHUD showGif];
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, 0.001 * NSEC_PER_SEC), dispatch_get_main_queue(), ^(void){
        ...
        [self->parm setObject:[FZUserInformation shareInstance].userModel.schoolId forKey:@"schoolId"];
        [self->parm setObject:[FZUserInformation shareInstance].userModel.gradeId  forKey:@"gradeId"];
