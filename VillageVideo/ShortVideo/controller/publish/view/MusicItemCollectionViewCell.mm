...
//        [_iconImgView makeCornerRadius:35 borderColor:nil borderWidth:0];
        ...
        _downLaodImgView  = [[UIImageView alloc]init];
        _downLaodImgView.backgroundColor = [UIColor redColor];
        _downLaodImgView.image = [UIImage imageNamed:@"音乐下载"];
        [_iconImgView addSubview:_downLaodImgView];
        [_downLaodImgView mas_makeConstraints:^(MASConstraintMaker *make) {
            make.right.equalTo(self->_iconImgView).offset(0);
            make.width.height.equalTo(@(20));
            make.bottom.mas_equalTo(self->_iconImgView.mas_bottom);
        }];
        ...
        [_nameLabel mas_makeConstraints:^(MASConstraintMaker *make) {
            make.centerX.equalTo(self);
            make.top.equalTo(self->_iconImgView.mas_bottom).offset(5);
            make.left.right.equalTo(self->_iconImgView);
        }];
