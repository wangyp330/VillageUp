...
//    self.edgesForExtendedLayout = UIRectEdgeNone;
    self.title = @"AR教材";
        ...
        if ([aa isEqualToString:@"1"]) {
            ...
            //同屏
            UIButton *syncScreenButton = [UIButton buttonWithType:UIButtonTypeCustom];
            [syncScreenButton setTitle:@"同屏" forState:(UIControlStateNormal)];
            [syncScreenButton setTitleColor:[UIColor colorWithHexString:@"000000"] forState:(UIControlStateNormal)];
            [syncScreenButton addTarget:self action:@selector(syncScreenClick) forControlEvents:UIControlEventTouchUpInside];
            [syncScreenButton.titleLabel setFont:[UIFont systemFontOfSize:15]];
            UIBarButtonItem *rightBarItem = [[UIBarButtonItem alloc]initWithCustomView:syncScreenButton];
            self.navigationItem.rightBarButtonItem = rightBarItem;
        }
...
//    [syncScreenButton addTarget:self action:@selector(syncScreenClick) forControlEvents:UIControlEventTouchUpInside];
//    [syncScreenButton.titleLabel setFont:[UIFont systemFontOfSize:15]];
//    [self.view addSubview:syncScreenButton];
//    [syncScreenButton mas_makeConstraints:^(MASConstraintMaker *make) {
