    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if (i != 0){
            if (i != buttonTitles.count) {
                UIView *btnLine=[[UIView alloc]initWithFrame:CGRectMake(i*buttonWidth, container.height - buttonHeight, 0.5, buttonHeight)];
                btnLine.backgroundColor=[UIColor lightGrayColor];
                [container addSubview:btnLine];
            }
        }
        ...
        [closeButton setTitleColor:APP_BLUE_COLOR forState:UIControlStateNormal];
