...
//App_JAIOXUYE_BASE_URL
   ...
   webvc.hostUrl = [NSString stringWithFormat:@"http://192.168.50.73:7094/#/articleList?userId=%@&machineType=ios&version=%@&villgeId=%@&groupId=%@",[FZUserInformation shareInstance].userModel.uid,versionNumString,[FZUserInformation shareInstance].userModel.villageId,[FZUserInformation shareInstance].userModel.groupId];
    //
