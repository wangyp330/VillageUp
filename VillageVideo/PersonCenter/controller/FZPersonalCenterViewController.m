...
- (UIViewController *)magicView:(VTMagicView *)magicView viewControllerAtPage:(NSUInteger)pageIndex
{
    ...
    if ([menuInfo isEqualToString:@"作品"]) {
        ...
        //事迹
        self.articleViewController.hostUrl=[NSString stringWithFormat:@"http://192.168.50.73:7094/#/myArticleList?userId=%@",[FZUserInformation shareInstance].userModel.uid];
        //[NSString stringWithFormat:@"%@/#/myArticleList?userId=%@&uid=%@",App_JAIOXUYE_BASE_URL,[FZUserInformation shareInstance].userModel.uid,self.userId];
