...
//        [self addSubview:skipButton];
        ...
        for (int i=0; i<imageNameArray.count; i++) {
            ...
            if (i == imageNameArray.count-1 && isHidden == NO) {
                ...
                UIButton *startButton = [[UIButton alloc]initWithFrame:CGRectMake(DDScreenW*0.3, DDScreenH*0.8, 150, DDScreenH*0.08)];
                ...
                startButton.backgroundColor = APP_BLUE_COLOR;
        ...
        self.imagePageControl.pageIndicatorTintColor = [UIColor colorWithHexString:@"e0e0e0"];
        self.imagePageControl.currentPageIndicatorTintColor =APP_BLUE_COLOR;
